//! RTS9060 Nano turntable driver for the current PC-direct topology.
//!
//! This module owns the versioned line protocol, serial worker, identity
//! validation, motion acknowledgements, and emergency-stop behavior. Protocol
//! command names are external device contracts and must not be changed without
//! a matching active firmware implementation and parity tests.
